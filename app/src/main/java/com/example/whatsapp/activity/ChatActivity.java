...
public class ChatActivity extends AppCompatActivity {
    ...
    private List<Mensagens> list_mensagens=new ArrayList<>();
    ...
    private List<Usuario> listUsuariosComuns=new ArrayList<>();
    ...
    private HashMap<String, Integer> hashVisualizado=new HashMap<String, Integer>();
